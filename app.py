...
app.config['MAIL_USERNAME'] = 'jhduhiud@gmail.com'
app.config['MAIL_PASSWORD'] = 'jhadjkahjdahkd'
app.config['MAIL_DEFAULT_SENDER'] = 'Hostel Management', 'jahdhwddjd@gmail.com'
